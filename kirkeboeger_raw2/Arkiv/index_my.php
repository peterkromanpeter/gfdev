...
<body>
   <!-- Søge felt til sogne -->
    ...
    <input type="text" style="height:25px;border: 1px solid #666666;border-radius:2px;color:#666666;label="Sogn, Amt, Herred";" name="query"  />
...
<?php
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($con, "SELECT * FROM kirkebogssogne
            WHERE (`Sogn` LIKE '%".$query."%') OR (`Amt`='$query') OR (`Herred`='$query') OR (`Staden`='$query')") or die(mysql_error());
